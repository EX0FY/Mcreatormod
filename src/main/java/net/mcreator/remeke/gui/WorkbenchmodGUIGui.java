...
package net.mcreator.remeke.gui;
...
public class WorkbenchmodGUIGui extends RemekeModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public WorkbenchmodGUIGui(RemekeModElements instance) {
		super(instance, 18);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("workbenchmod_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 7, 38) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 25, 38) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 43, 38) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 7, 56) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 25, 56) {
			}));
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				RemekeMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("remeke:textures/workbenchmod_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("\u041A\u0430\u043C\u0435\u043D\u043D\u044B\u0439 \u0432\u0435\u0440\u0441\u0442\u0430\u043A", 6, 5, -12829636);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 67, this.guiTop + 57, 60, 20, "Создать", e -> {
				RemekeMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
