...
public class HelldLukItem extends RemekeModElements.ModElement {
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybullethelld_luk").setRegistryName("entitybullethelld_luk"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(VkladkaItemGroup.tab).maxDamage(200));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"\u043B\u0443\u043A \u0441\u0434\u0435\u043B\u0430\u043D\u043D\u044B\u0439 \u0438\u0437 \u043E\u0441\u043A\u043E\u043B\u043A\u043E\u0432 \u0445\u0435\u043B\u043B\u0434\u0435\u0440\u0438\u0443\u043C\u0430"));
			list.add(new StringTextComponent(
					"\u0434\u0435\u043B\u0430\u0435\u0442 \u0432\u0441\u0435 \u0441\u0442\u0440\u0435\u043B\u044B \u043E\u0433\u043D\u0435\u043D\u044B\u043C\u0438."));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.5f, 6, 0);
