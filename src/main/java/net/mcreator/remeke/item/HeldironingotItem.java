...
public class HeldironingotItem extends RemekeModElements.ModElement {
	@ObjectHolder("remeke:heldironingot")
	public static final Item block = null;
	public HeldironingotItem(RemekeModElements instance) {
		super(instance, 27);
	}
